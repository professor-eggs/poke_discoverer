...
void main() {
  group('PokemonCsvParser', () {
    test(
      'includes version metadata with sorted details for moves',
      () {
        final entities = PokemonCsvParser.parse(
          ...
          versions: const [
            ...
            {'id': '24', 'version_group_id': '15', 'identifier': 'alpha-sapphire'},
          ...
          versionNames: const [
            ...
            {'version_id': '24', 'local_language_id': '9', 'name': 'Alpha Sapphire'},
